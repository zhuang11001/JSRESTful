...
//        document.getElementById("ConfigParametersTxt").innerHTML = resdata;
    $.ajax({
...
function KeyEncryptByDigitalEnvelope(){
    $.ajax({
        ...
        data:{
            ...
            certBase:$("#certBase2").val()
        },
        success:function(res){
            var msg=JSON.stringify(res);
            document.getElementById("KeyEncryptTxt").innerHTML = msg;
            console.log(res);
        },
        error:function(res){
            console.log(res);
...
function KeyDecryptByDigitalEnvelope(){
    $.ajax({
        ...
        success:function(res){
            var msg=JSON.stringify(res);
            document.getElementById("KeyDecryptByDigitalTxt").innerHTML = msg;
            console.log(res);
        },
        error:function(res){
            console.log(res);
...
function VerifySignByP7(){
    $.ajax({
        ...
        success:function(res){
            ...
            document.getElementById("VerifySignByP7Txt").innerHTML = smg;
            console.log(res);
        },
        error:function(res){
            console.log(res);
...
function KeyDigitalSignByP1(){
    $.ajax({
        ...
        success:function(res){
            var smg=JSON.stringify(res);
            document.getElementById("KeyDigitalSignByP1Txt").innerHTML = smg;
            console.log(res);
        },
        error:function(res){
            console.log(res);
...
function VerifyDigitalSignByP1(){
    $.ajax({
        ...
        success:function(res){
            var smg=JSON.stringify(res);
            document.getElementById("VerifyDigitalSignByP1Txt").innerHTML = smg;
            console.log(res);
        },
        error:function(res){
            console.log(res);
...
function KeySignByP1(){
    $.ajax({
        ...
        success:function(res){
            var smg=JSON.stringify(res);
            document.getElementById("KeySignByP1Txt").innerHTML = smg;
            console.log(res);
        },
        error:function(res){
            console.log(res);
...
function VerifySignByP1(){
    $.ajax({
        url:commonUrl+"/RS_KeyVerifySignByP1 ",
        type:"post",
        data:{
        ...
        success:function(res){
            var smg=JSON.stringify(res);
            document.getElementById("VerifySignByP1Txt").innerHTML = smg;
            console.log(res);
        },
        error:function(res){
            console.log(res);
...
function KeySignByP7(){
    $.ajax({
        ...
        success:function(res){
            var smg=JSON.stringify(res);
            document.getElementById("KeySignByP7Txt").innerHTML = smg;
            console.log(res);
        },
        error:function(res){
            console.log(res);
